...
<div class="form">
	<html:form action="/gasto/gasto-organizacion-form-validate.do?method=save" styleId="abmForm">
		...
		<div class="boton">
			<a href="#" onclick="gastoOrganizacionForm.submit();" tabindex="17"><bean:message key="antares.base.aceptar.label" /> </a> <a href="<c:url value="/gasto/gasto-organizacion-query.do?method=lastQuery"/>"><bean:message key="antares.base.cancelar.label" /> </a>
		</div>
