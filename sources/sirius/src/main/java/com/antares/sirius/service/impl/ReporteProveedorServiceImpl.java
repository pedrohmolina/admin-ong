...
/**
 * Implementacion de la interfaz ReporteProveedorService.
 *
 * @version 1.0.0 Created 23/04/2011 by Pablo Delfino
 * @author <a href:mailto:pnicdelfino@gmail.com> Pablo Delfino </a>
 *
 */
public class ReporteProveedorServiceImpl implements ReporteProveedorService{
	...
	public JasperPrint generateReportBytes(Collection<Proveedor> proveedores) throws ServiceException{
		...
		try {
			...
			return ReportUtils.generateReportBytes(Constants.REPORTE_PROVEEDORES, parametros, proveedores);
