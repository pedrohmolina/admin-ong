...
(
	...
	telefono VARCHAR(20) COMMENT 'Tel�fono del Proveedor',
...
(
	...
	numeroDocumento NUMERIC(10) NOT NULL COMMENT 'N�mero de Documento de la Persona.',
	cuit VARCHAR(20) NOT NULL COMMENT 'N�mero de CUIT o CUIL de la Persona',
	cbu VARCHAR(50) NOT NULL COMMENT 'N�mero de C�digo Bancario �nico de la Persona',
...
(
	...
	descripcion VARCHAR(255) NOT NULL COMMENT 'Descripci�n de la Relación Contractual',
	activo BOOL NOT NULL COMMENT 'Señal para manejo de baja logica',
	PRIMARY KEY (id),
...
INSERT INTO areatematica (id,descripcion) VALUES (3,'Educación Basica');
...
insert into persona (id, apellido, nombre, segundoNombre, idTipoDocumento, numeroDocumento, cuit, cbu, nacionalidad, fechaNacimiento, profesion, direccion, telefono, celular, email, funcion, idRelacionContractual, idFormaPago, idPersonaFactura, observaciones, activo) values (1, 'Martinez', 'Julian', '', 1, 29319345, '', '', '', null, '', '', '', '', '', '', 1, 1, null, '', '1');
...
-- Agregar Meta
INSERT INTO `meta` (`id`, `nombre`, `descripcion`, `ponderacion`, `idObjetivoEspecifico`, `activo`) VALUES ('1', 'Vacunar a 70 chicos de la zona Sur de Moron', 'Vacunar a 70 chicos de la zona Sur de Morón contra la gripe', '70.0', '1', '1');
...
INSERT INTO `proyecto` (`id`, `idEstadoProyecto`, `idTipoAgrupamiento`, `nombre`, `descripcion`, `fechaInicio`, `fechaFin`, `ubicacion`, `responsable`, `beneficiariosDirectos`, `beneficiariosIndirectos`, `financiador`, `presupuestoTotal`, `resumen`, `idArchivo`, `activo`) VALUES
  ...
  (3, 2, 1, 'Jóvenes Promotores de Salud', 'Capacitar y promover a jovenes promotores de Salud vv', '2011-08-03', '2011-08-17', 'Manzanares. Partido de Pilar. Provincia de Buenos Aires.', 7, 'Mujeres: 34\r\nHombres: 7\r\nNiños/as: 234\r\nTOTAL: 275', 'Mujeres: 486\r\nHombres: 449\r\nNiños/as: 530\r\nTOTAL: 1.465', 4, 94010, NULL, NULL, 1),
