...
<div class="form">
	<html:form action="/asignacion/asignacion-query-validate.do?method=query">
	<div style="float: left; width: 100%;">
		...
		<html:select property="filtroIdProyecto" styleId="proyecto" onchange="cargarComboActividad(this, 'actividad');">
			...
			<html:optionsCollection name="asignacionQuery" property="proyectos" label="nombre" value="id"/>
		</html:select>
		</p><br><p>
		...
		<html:select property="filtroIdActividad" styleId="actividad">
			<html:option value=""><bean:message key="antares.base.seleccione.label"/></html:option>
			<html:optionsCollection name="asignacionQuery" property="actividades" label="nombre" value="id"/>
		</html:select>
		</p><br><p>
		<label for="filtroIdPersona"><bean:message key="sirius.asignacion.persona.label" />&nbsp;:</label>
		<html:select property="filtroIdPersona">
			<html:option value=""><bean:message key="antares.base.seleccione.label" /></html:option>
			<html:optionsCollection name="asignacionQuery" property="personas" label="nombreYApellido" value="id" />
		</html:select>
		</p><br>
	</div>
	...
	<div style="float: left; width: 100%;">
		<div class="boton">
			...
			<authz:authorize ifAllGranted="ENTIDAD_ASIGNACION-LISTADO">
				<a href="#" onclick="asignacionQuery.submit();"><bean:message key="antares.base.buscar.label" /></a>
			</authz:authorize>
