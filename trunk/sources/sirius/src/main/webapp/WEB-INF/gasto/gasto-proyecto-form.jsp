...
<div class="form">
	<html:form action="/gasto/gasto-proyecto-form-validate.do?method=save"
		styleId="abmForm">
		...
		<div style="float: left;">
			...
			<br>
			<logic:equal name="gastoProyectoForm" property="individual"
				value="true">
				<p>
		...
		<div class="boton">
			<a href="#" onclick="gastoProyectoForm.submit();" tabindex="17"><bean:message key="antares.base.aceptar.label" />
			</a> <a href="<c:url value="/gasto/gasto-proyecto-query.do?method=lastQuery"/>"><bean:message key="antares.base.cancelar.label" /> </a>
		</div>
