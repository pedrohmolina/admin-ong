...
<div class="form">
<html:form action="/gasto/gasto-actividad-form.do?method=view">
	<div style="float:left;">
		...
		<label for="labelActividad"><bean:message key="sirius.gasto.actividad.label" />:</label>
	...
	<div class="boton">
		<a href="<c:url value="/gasto/gasto-actividad-query.do?method=lastQuery"/>"><bean:message key="antares.base.volver.label" /></a>
	</div>
