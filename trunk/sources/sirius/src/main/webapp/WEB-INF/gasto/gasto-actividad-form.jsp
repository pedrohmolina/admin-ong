...
<script>
	...
	function cargarComboActividad(select, destinationCombo) {
		...
		if (selectedOption != "") {
			...
			$("#" + destinationCombo).ajaxAddOption(url, {
				idProyecto : selectedOption
			}, false);
		}
	}
</script>
...
<div class="form">
	<html:form action="/gasto/gasto-actividad-form-validate.do?method=save"
		...
		<div style="float: left;">
			...
			<logic:equal name="gastoActividadForm" property="agrupado"
				value="true">
				<p>
		...
		<div class="boton">
			<a href="#" onclick="gastoActividadForm.submit();" tabindex="17"><bean:message key="antares.base.aceptar.label" /> </a> <a href="<c:url value="/base/home_init.do"/>"><bean:message key="antares.base.cancelar.label" /> </a>
		</div>
